...
export default function SearchSection() {
	...
	const handleClearFilters = () => (reset(), updateQuery?.({}), setParam('search', undefined!));
	const handleSearch = () => (updateQuery?.(query), setParam('search', query.search!));
	...
	return (
		<section className="pt-4 py-16 bg-white rounded-t-xl mt-4 md:mt-0">
					...
					<div className="space-y-6 max-w-5xl mx-auto">
						...
						<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
							...
							<SelectDocType
								...
								onSelect={(document_type) => changeQuery('document_type', document_type)}
						...
						<div className="flex flex-row gap-4 justify-center md:max-w-[400px] mx-auto">
							<Button type="button" variant="filled" size="small" fullWidth onClick={handleSearch}>
								Search
							</Button>
							<Button type="button" variant="outline" size="small" fullWidth onClick={handleClearFilters}>
								Clear Filters
							</Button>
						</div>
					</div>
